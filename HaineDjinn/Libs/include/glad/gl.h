/**
 * Loader generated by glad 2.0.0-beta on Tue Apr 19 13:31:34 2022
 *
 * Generator: C/C++
 * Specification: gl
 * Extensions: 2
 ...
 *
 * Commandline:
 *    --api='gl:core=4.5' --extensions='GL_EXT_texture_compression_s3tc,GL_NV_command_list' c --loader
 *
 * Online:
 *    http://glad.sh/#api=gl%3Acore%3D4.5&extensions=GL_EXT_texture_compression_s3tc%2CGL_NV_command_list&generator=c&options=LOADER
 *
 */
...
#endif
#ifdef __gl_h_
  #pragma message OpenGL (gl.h) header already included (API: gl), remove previous include!
#endif
#define __gl_h_ 1
#ifdef __gl3_h_
